...
export default function ClientsPage() {
  ...
  const { data, loading, error, refreshClients } = useClients(
    currentPage,
    limit,
    searchTerm
  );
  ...
  const handleExportCSV = async () => {
    try {
      setIsExporting(true);
      await ClientsAPI.exportClientsCSV(searchTerm);
      toast({
        title: "Export Successful",
        description: "Clients data has been exported to CSV file.",
      });
    } catch (error) {
      console.error("Export error:", error);
      toast({
        title: "Export Failed",
        description: "Failed to export clients data. Please try again.",
        variant: "destructive",
      });
    } finally {
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  {client.firstName} {client.lastName}? This
