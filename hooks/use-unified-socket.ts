...
export function useUnifiedSocket({ 
  ...
  const emitAnnotation = useCallback((data: any) => {
  ...
  const emitAnnotationReply = useCallback((data: any) => {
    if (!socket || !isConnected) {
  ...
  const emitReplyEdit = useCallback((data: any) => {
    if (!socket || !isConnected) {
  ...
  const emitReplyDelete = useCallback((data: any) => {
    if (!socket || !isConnected) {
  ...
  const emitAnnotationStatusChange = useCallback((data: any) => {
    if (!socket || !isConnected) {
  ...
  const emitProjectStatusChange = useCallback((data: any) => {
    if (!socket || !isConnected) {
      console.warn('⚠️ Socket not connected, cannot emit project status change')
      return false
    }
  ...
  const emitTyping = useCallback((data: any) => {
    if (!socket || !isConnected) {
